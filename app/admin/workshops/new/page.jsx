...
export default function NewWorkshopPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await res.json();
      if (!res.ok) throw new Error(data.message || 'Error creating workshop');
    ...
    <div className="max-w-4xl space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <h1 className="font-serif font-light text-charcoal text-display-xs">Create New Workshop</h1>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-ivory border border-border p-6 sm:p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="sm:col-span-2">
            <Input
              ...
              placeholder="e.g. Beginners Crochet Granny Square Workshop"
            />
          </div>
          <Select
        ...
        <Textarea
          ...
          placeholder="Describe what attendees will learn, what yarn/hooks are included, and who it is suitable for..."
        />
        ...
        <div className="space-y-4 border-t border-border/60 pt-6">
          ...
          {isOnline ? (
            ...
            <Input
              ...
              placeholder="Noolinnayam Studio, Indiranagar, Bengaluru"
            />
          )}
        </div>

        {/* Seats & Pricing */}
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-border/60 pt-6">
          <Input
